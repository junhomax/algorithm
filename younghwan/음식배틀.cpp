...
struct DATA
{
	int taste[2]; //0:김준현, 1: 문세윤
	int idx;
	int dist;
	int order;

	DATA(int kim = 0, int moon = 0, int idx = 0, int order = 0, int dist = 0)
	{
		taste[0] = kim, taste[1] = moon, this->dist = dist;
		this->idx = idx;
		this->order = order;
	}
};

DATA data[2][100000 + 10]; //0:김준현, 1:문세윤
DATA tmp[100000 + 10];
int arr[2][100000 + 10];
